 ...
 * 
 */
class MOONSDK_API OpenAPIUniswapInput : public Model
{
public:
    virtual ~OpenAPIUniswapInput() {}
	...
	TOptional<FString> TokenA;
	TOptional<FString> TokenB;
	TOptional<FString> AmountA;
	TOptional<FString> AmountB;
};
