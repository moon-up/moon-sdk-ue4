 ...
 * 
 */
class MOONSDK_API OpenAPIAaveInput : public Model
{
public:
    virtual ~OpenAPIAaveInput() {}
	...
	TOptional<FString> LendingPool;
	TOptional<FString> Amount;
	TOptional<FString> AtokenToRedeeem;
	TOptional<FString> RefCode;
	TOptional<FString> InterestRateMode;
};
