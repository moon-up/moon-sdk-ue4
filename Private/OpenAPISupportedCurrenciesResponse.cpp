...
void OpenAPISupportedCurrenciesResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISupportedCurrenciesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
