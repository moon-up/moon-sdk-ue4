...
void OpenAPIBroadCastRawTransactionResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBroadCastRawTransactionResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
