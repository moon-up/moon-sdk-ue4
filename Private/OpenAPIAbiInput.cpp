...
void OpenAPIAbiInput::WriteJson(JsonWriter& Writer) const
{
	...
	if (Indexed.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("indexed")); WriteJsonValue(Writer, Indexed.GetValue());
	}
	if (Components.IsSet())
	{
...
bool OpenAPIAbiInput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("indexed"), Indexed);
