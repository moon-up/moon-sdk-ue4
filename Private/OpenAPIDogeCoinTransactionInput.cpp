...
void OpenAPIDogeCoinTransactionInput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDogeCoinTransactionInput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
