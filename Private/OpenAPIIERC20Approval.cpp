...
void OpenAPIIERC20Approval::WriteJson(JsonWriter& Writer) const
{
	...
	Writer->WriteIdentifierPrefix(TEXT("spender")); WriteJsonValue(Writer, Spender);
...
bool OpenAPIIERC20Approval::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("spender"), Spender);
