...
void OpenAPIDogeCoinTransactionOutput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDogeCoinTransactionOutput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
