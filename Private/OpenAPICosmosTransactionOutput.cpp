...
void OpenAPICosmosTransactionOutput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICosmosTransactionOutput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
