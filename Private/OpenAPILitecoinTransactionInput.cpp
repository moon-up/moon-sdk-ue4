...
void OpenAPILitecoinTransactionInput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPILitecoinTransactionInput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
