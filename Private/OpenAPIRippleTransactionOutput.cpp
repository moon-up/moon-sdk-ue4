...
void OpenAPIRippleTransactionOutput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRippleTransactionOutput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
