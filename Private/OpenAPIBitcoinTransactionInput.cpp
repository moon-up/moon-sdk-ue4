...
void OpenAPIBitcoinTransactionInput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBitcoinTransactionInput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
