...
void OpenAPISolanaTransactionOutput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISolanaTransactionOutput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
