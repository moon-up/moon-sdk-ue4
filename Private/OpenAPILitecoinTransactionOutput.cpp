...
void OpenAPILitecoinTransactionOutput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPILitecoinTransactionOutput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
