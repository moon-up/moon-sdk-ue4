...
#include "OpenAPIBitcoinCashAPIResponse.h"
...
void OpenAPIBitcoinCashAPIResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBitcoinCashAPIResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
