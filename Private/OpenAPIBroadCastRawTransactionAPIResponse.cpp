...
void OpenAPIBroadCastRawTransactionAPIResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBroadCastRawTransactionAPIResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
