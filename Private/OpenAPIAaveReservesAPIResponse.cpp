...
void OpenAPIAaveReservesAPIResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAaveReservesAPIResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
