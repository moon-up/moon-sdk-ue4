...
void OpenAPIBitcoinTransactionOutput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBitcoinTransactionOutput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
